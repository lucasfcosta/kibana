...
export const browserNormalizers: BrowserNormalizerMap = {
  ...
  [ConfigKeys.DOWNLOAD_SPEED]: getBrowserJsonToJavascriptNormalizer(ConfigKeys.DOWNLOAD_SPEED),
  [ConfigKeys.UPLOAD_SPEED]: getBrowserJsonToJavascriptNormalizer(ConfigKeys.UPLOAD_SPEED),
  [ConfigKeys.LATENCY]: getBrowserJsonToJavascriptNormalizer(ConfigKeys.LATENCY),
